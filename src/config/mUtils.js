 ...
 *  Math.ceil()函数返回大于或者等于一个给定数字的最小整数.向上取整
 *  Math.floor()向下取整
 ...
 export const animate = (element, target, duration = 400, mode = 'ease-out', callback) =>{
    ...
    element.timer = setInterval(() =>{
        Object.keys(target).forEach(attr =>{
            ...
            let intervalTime; //将目标氛围多少步执行.数值越大,步长越小,运动时间越长
            switch (mode) {
                case 'ease-out':
                    speedBase = iCurrent;
